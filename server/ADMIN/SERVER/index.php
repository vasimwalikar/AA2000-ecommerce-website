    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
          ...
          <p class="pull-right visible-xs">
           ...
           <div class="jumbotron">
            <center><h2>AA2000 Security and Technology</h2></center>
          </div>
...
<div class="well">
 ...
 <?php
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <form method="post">
                    <input type="hidden" name="image" value="ADS/<?php echo $row['image'];?>"  />
                    <input type="hidden" name="name" value="<?php echo $row['name'];?>" />
                    <input type="image" src="ADS/<?php echo $row['image'];?>" name="image"  class="img-responsive"/>
                </form>
            </div>
            <div class="col-md-6">
...
<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
           <a title="Recovery Database" href="Recovery.php" class="list-group-item">Database Recovery</a>
           <a title="Customer, Asset, Order Archive" href="customer_archive.php" class="list-group-item">Recent Activity</a>
            <a title="History" href="Customer_loginout.php" class="list-group-item">Audit Trail</a>
          </div>
        </div><!--/span-->
      </div><!--/row-->
      <?php
